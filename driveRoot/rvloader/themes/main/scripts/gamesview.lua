...
function init()
    ...
    if GamesView.getGamesType() == GamesView.gameType.GC_GAME then
        ...
        menuSystem:setEntryIncreaseAction(menuSystem.increaseEntryValue)
        menuSystem:setEntryDecreaseAction(menuSystem.decreaseEntryValue)
        menuSystem:addEntry("BBA Emulation", false)
        menuSystem:addEntryOption("Disabled", 0)
        menuSystem:addEntryOption("Enabled", 1)
        menuSystem:setEntryIncreaseAction(menuSystem.increaseEntryValue)
        menuSystem:setEntryDecreaseAction(menuSystem.decreaseEntryValue)
        menuSystem:addEntry("BBA Network Profile", false)
        menuSystem:addEntryOption("Auto", 0)
        menuSystem:addEntryOption("Profile 1", 1)
        menuSystem:addEntryOption("Profile 2", 2)
        menuSystem:addEntryOption("Profile 3", 3)
        menuSystem:setEntryIncreaseAction(menuSystem.increaseEntryValue)
        menuSystem:setEntryDecreaseAction(menuSystem.decreaseEntryValue)
